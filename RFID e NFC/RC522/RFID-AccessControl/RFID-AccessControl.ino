...
//byte readCard[4];
char *accessID[] = {"62927C1C", "Robson Brasil"}; // REPLACE this Tag ID with your Tag ID!!!
String tagID = "";
...
LiquidCrystal_I2C lcd(0x27, 20, 4); //Parameters: (addr,columns,rows)
Servo doorRele;
...
void setup()
{
  ...
  doorRele.attach(13); //Servo attached pin 3
  doorRele.write(doorClose); //Ensure the door is closed
//  digitalWrite(Rele, HIGH); //Ensure the door is closed
