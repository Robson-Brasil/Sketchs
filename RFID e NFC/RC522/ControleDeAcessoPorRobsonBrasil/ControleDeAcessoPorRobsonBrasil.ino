...
#define led_red 27
#define buzzer 17
#define door_lock 13  //Ligado em um LED para testes, toque-o pelo sensor que vc preferir
#define door_sens 33  //Sensor de fim de curso, o RFID só lerá outro cartão, quando a porta for fechada
...
void rfid_func()  //Função para identificação das tags RFID
{
  ...
  if (conteudo.substring(1) == "62 92 7C 1C")  //Cartão 1 para liberar acesso
  {
    ...
    while (digitalRead(door_sens)) digitalWrite(door_lock, LOW);
    digitalWrite(door_lock, HIGH);
