...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  Serial.print("] ");
    ...
    // Switch on the LED if an 1 was received as first character
    if ((char)payload[0] == '0') {
      digitalWrite(Rele5, LOW);   // Turn the LED on (Note that LOW is the voltage level
      EstadoDoBotao1 = 0;
      client.publish(pub5, "0");
    } 
    else {
      digitalWrite(Rele5, HIGH);  // Turn the LED off by making the voltage HIGH
      EstadoDoBotao1 = 1;
    ...
    // Switch on the LED if an 1 was received as first character
    if ((char)payload[0] == '0') {
      digitalWrite(Rele6, LOW);   // Turn the LED on (Note that LOW is the voltage level
      EstadoDoBotao2 = 0;
      client.publish(pub6, "0");
    } 
    else {
      digitalWrite(Rele6, HIGH);  // Turn the LED off by making the voltage HIGH
      EstadoDoBotao2 = 1;
    ...
    // Switch on the LED if an 1 was received as first character
    if ((char)payload[0] == '0') {
      digitalWrite(Rele7, LOW);   // Turn the LED on (Note that LOW is the voltage level
      EstadoDoBotao3 = 0;
      client.publish(pub7, "0");
    } 
    else {
      digitalWrite(Rele7, HIGH);  // Turn the LED off by making the voltage HIGH
      EstadoDoBotao3 = 1;
    ...
    // Switch on the LED if an 1 was received as first character
    if ((char)payload[0] == '0') {
      digitalWrite(Rele8, LOW);   // Turn the LED on (Note that LOW is the voltage level
      EstadoDoBotao4 = 0;
      client.publish(pub8, "0");
    } 
    else  {
      digitalWrite(Rele8, HIGH);  // Turn the LED off by making the voltage HIGH
      EstadoDoBotao4 = 1;
